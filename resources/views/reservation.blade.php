            ...
            <div class="col-lg-6 align-self-center">
                <div class="left-text-content">
                    <div class="section-heading">
                        <h6>Contact Us</h6>
                        <h2>Make A Reservation Or Just walkin to our cafe</h2>
                    </div>
                    <p></p>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="phone">
                                ...
                                <h4>Phone Numbers</h4>
                                <span><a href="#">01719625326</a><br><a href="#">912-324-234</a></span>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="message">
                                ...
                                <h4>Emails</h4>
                                <span><a href="#">klassy@gmail.com</a><br><a href="#">klassy1990@yahoo.com</a></span>
                            </div>
                        </div>
                    </div>
                </div>
