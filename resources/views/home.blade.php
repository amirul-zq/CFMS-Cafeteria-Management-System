                                                ...
                                                <div class="left-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            ...
                                                            <p>Made with cooked chicken, lettuce, tomatoes, cucumbers,
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            ...
                                                            <h4>Orange Juice</h4>
                                                            <p>Made from freshly squeezed oranges.</p>
                                                            <div class="price">
                                                                <h6>BDT 50</h6>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            ...
                                                            <h4>Fruit Salad</h4>
                                                            <p>Made with a mix of fresh fruits like apples, bananas,
                                                                grapes, and melons.</p>
                                                            <div class="price">
                                                                <h6>BDT 80</h6>
                                                            </div>
                                                ...
                                                <div class="right-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            ...
                                                            <h4>Eggs Omelette</h4>
                                                            <p>Made with beaten eggs, often with onions, herbs, and
                                                                peppers.</p>
                                                            <div class="price">
                                                                <h6>BDT 50</h6>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            ...
                                                            <h4>Dollma Pire</h4>
                                                            <p>Stuffed grape leaves (dollma) with rice and spices,
                                                                served with mashed potatoes (pire).
